        ...
        <div className="container">
          ...
          <section className="hero" style={{ paddingTop: 72, paddingBottom: 48, textAlign: 'center' }}>
            ...
            <div style={{ marginTop: 36, display: 'flex', justifyContent: 'center' }}>
              <Image id="hero" src="/herov7.jpg" alt="Custom painted jeans" width={1024} height={1024} style={{ width: '100%', maxWidth: 560, height: 'auto', borderRadius: 16, boxShadow: '0 12px 40px rgba(0,0,0,0.15)' }} />
            </div>
          </section>
