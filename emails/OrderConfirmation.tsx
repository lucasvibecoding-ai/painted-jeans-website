    ...
    <Html>
      ...
      <Body style={body}>
        <Container style={container}>
          ...
          <Text style={optionText}>
            <strong>Option 2 — Wait for the full launch.</strong> It&apos;s coming mid-April. It&apos;s going to be incredible. As a thank you for your patience, I&apos;ll give you a <strong>steep discount</strong> on the Painted Jeans Community once it opens — it&apos;s going to be a private space for fellow painted jeans creators, and you&apos;ll get in at a fraction of the price.
          </Text>
          ...
          <Text style={spamStep}>
            <strong>2. Add me to your contacts.</strong> Save <strong>hello@katiepaintsjeans.com</strong> as a contact and future emails will go straight to your inbox.
          </Text>
